...
describe('tests', function() {
	...
	describe('POST endpoint', function() {
		...
		const newTerm = {year: "1", type_select: "root", english: "test_post", lao: "ພາສາ ລາວ", secret: "someString"};
		return chai.request(app)
			.post('/terms')
			.send(newTerm)
			.then(function(res) {
	...
	describe('PUT endpoint', function() {
		...
		it('should update term on PUT', function() {
			...
			const newTerm = {year: 1, type_select: "root", english: "test_put", lao: "ພາສາ ລາວ", secret: "someString" };
			return chai.request(app)
				.post('/terms')
				.send(newTerm)
				.then(function(res) {
	...
	describe('DELETE endpoint', function() {
		it('should delete terms on DELETE', function() {
			const newTerm = {year: 1, type_select: "root", english: "test_delete", lao: "ພາສາ ລາວ", secret: "someString" };
			return chai.request(app)
				.post('/terms')
				.send(newTerm)
				.then(function(res) {
